...
public class LoginController {
    ...
    private final JornadaLaboralOperadorJpaController jornadaLaboralOperadorDAO;
    private final TipoJornadaLaboralJpaController tipoJornadaLaboralDAO;

    //Model
    private static Usuario usuarioRegistradoInstanciaUnica = null;
    private static Municipalidad organismoInstanciaUnica = null;

    private JornadaLaboralOperador unaJornadaLabora;
    ...
    public LoginController() {
        ...
        this.jornadaLaboralOperadorDAO = new JornadaLaboralOperadorJpaController(Conexion.getEmf());
        this.tipoJornadaLaboralDAO = new TipoJornadaLaboralJpaController(Conexion.getEmf());

        //Singleton Municipalidad
        this.organismoInstanciaUnica = municipalidadDAO.findMunicipalidad(1l);
